...
cube_beijing_pm10 = cube_unit.interpolate([('latitude', 39.90), ('longitude', 116.41)], iris.analysis.Nearest())
cube_shijiazhuang_pm10 = cube_unit.interpolate([('latitude', 38.04), ('longitude', 114.51)], iris.analysis.Nearest())
cube_shanghai_pm10 = cube_unit.interpolate([('latitude', 31.23), ('longitude', 121.47)],iris.analysis.Nearest())
cube_nanjing_pm10 = cube_unit.interpolate([('latitude', 32.06), ('longitude', 118.80)],iris.analysis.Nearest())
cube_guangzhou_pm10 = cube_unit.interpolate([('latitude', 23.13), ('longitude', 113.26)],iris.analysis.Nearest())
cube_hongkong_pm10 = cube_unit.interpolate([('latitude', 22.33), ('longitude', 114.19)],iris.analysis.Nearest())

# =============================================================================
# unit: ug/m3 PM1
# =============================================================================
cube2 = iris.load(filename2)
cube2_unit = cube2[0]*10e9
...
cube_beijing_pm1 = cube2_unit.interpolate([('latitude', 39.90), ('longitude', 116.41)], iris.analysis.Nearest())
cube_shijiazhuang_pm1 = cube2_unit.interpolate([('latitude', 38.04), ('longitude', 114.51)], iris.analysis.Nearest())
cube_shanghai_pm1 =cube2_unit.interpolate([('latitude', 31.23), ('longitude', 121.47)],iris.analysis.Nearest())
cube_nanjing_pm1 = cube2_unit.interpolate([('latitude', 32.06), ('longitude', 118.80)],iris.analysis.Nearest())
cube_guangzhou_pm1 = cube2_unit.interpolate([('latitude', 23.13), ('longitude', 113.26)],iris.analysis.Nearest())
cube_hongkong_pm1 = cube2_unit.interpolate([('latitude', 22.33), ('longitude', 114.19)],iris.analysis.Nearest())
# =============================================================================
# Mean of hour
# =============================================================================
