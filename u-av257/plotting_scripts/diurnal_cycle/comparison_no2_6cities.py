...
#filename = '/exports/csce/datastore/geos/users/s1731217/u-av257/no2.pp'  # no2
filename2 = '/exports/csce/datastore/geos/users/s1731217/output_ukca/u-av256/dumped_pp_files/no2.pp'  # no2 (nudging)
...
obs_nan_no2 = pic.plot(x, no2_nan_m, linewidth=4, label = 'Obs_NO2', color ='r')
