...
# loading data (cube)
# =============================================================================
#filename_no2 = '/exports/csce/datastore/geos/users/s1731217/u-av257/no2.pp' # no2
filename2_no2 = '/exports/csce/datastore/geos/users/s1731217/output_ukca/u-av256/dumped_pp_files/no2.pp' # no2 (nudging)
#filename_o3 = '/exports/csce/datastore/geos/users/s1731217/output_ukca/O3/O3.pp'  # o3
filename2_o3 = '/exports/csce/datastore/geos/users/s1731217/output_ukca/u-av256/dumped_pp_files/o3.pp'  # o3 (nudging)
...
# unit: ug/m3
#cube_no2_unit_beijing = cube_no2[0]*1.284*1.0e9
#cube_no2_unit_shijiazhuang = cube_no2[0]*1.275*1.0e9
#cube_no2_unit_shanghai = cube_no2[0]*1.248*1.0e9
#cube_no2_unit_nanjing = cube_no2[0]*1.252*1.0e9
#cube_no2_unit_guangzhou = cube_no2[0]*1.213*1.0e9
#cube_no2_unit_hk = cube_no2[0]*1.209*1.0e9
#
#cube_o3_unit_beijing = cube_o3[0]*1.284*1.0e9
#cube_o3_unit_shijiazhuang = cube_o3[0]*1.275*1.0e9
#cube_o3_unit_shanghai = cube_o3[0]*1.248*1.0e9
#cube_o3_unit_nanjing = cube_o3[0]*1.252*1.0e9
#cube_o3_unit_guangzhou = cube_o3[0]*1.213*1.0e9
#cube_o3_unit_hk = cube_o3[0]*1.209*1.0e9

#nudged data : unit2
cube_no2_unit2_beijing = cube2_no2[0]*1.284*1.0e9
cube_no2_unit2_shijiazhuang = cube2_no2[0]*1.275*1.0e9
cube_no2_unit2_shanghai = cube2_no2[0]*1.248*1.0e9
cube_no2_unit2_nanjing = cube2_no2[0]*1.252*1.0e9
cube_no2_unit2_guangzhou = cube2_no2[0]*1.213*1.0e9
cube_no2_unit2_hk = cube2_no2[0]*1.209*1.0e9

cube_o3_unit2_beijing = cube2_o3[0]*1.284*1.0e9
cube_o3_unit2_shijiazhuang = cube2_o3[0]*1.275*1.0e9
cube_o3_unit2_shanghai = cube2_o3[0]*1.248*1.0e9
cube_o3_unit2_nanjing = cube2_o3[0]*1.252*1.0e9
cube_o3_unit2_guangzhou = cube2_o3[0]*1.213*1.0e9
cube_o3_unit2_hk = cube2_o3[0]*1.209*1.0e9
...
obs_no2 = pic.plot(x_cn, y_no2_hongkong, linewidth = 4, label = 'Obs (ug/m3)', color = 'red')
...
obs_o3 = pic.plot(x_cn, y_o3_hongkong, linewidth = 4, label = 'Obs (ug/m3)', color = 'gold')
