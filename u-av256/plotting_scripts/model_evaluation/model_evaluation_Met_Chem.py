...
cube_t_unit_beijing       = cube_t[0]-273
cube_t_unit2_beijing      = cube_t_n[0]-273
cube_bl_unit_beijing      = cube_bl[0]
cube_bl_unit2_beijing     = cube_bl_n[0]
cube_p_unit_beijing       = cube_p[0]/100
cube_p_unit2_beijing      = cube_p_n[0]/100
...
#plt.xlabel('Day')
plt.ylabel(' Sepcific Humidity (kg/kg)')
#plt.legend(loc = 1)
...
beijing_p = pic.plot(x_utc, cube_beijing_p.data, linewidth=4, label = 'Model: u, v, humidity, T, BL, P in Beijing in June', color = 'k')
...
beijing_pm = pic.plot(x_utc, cube_beijing_pm.data, linewidth=4, label = 'Model PM1', color = 'darkblue')
beijing_pm_nudging = pic.plot(x_utc, cube_beijing_pm_nudge.data, linewidth=4, label = 'Nudged Model PM1', color = 'green')
obs_pm = pic.plot(x_cn, y_pm_beijing, linewidth = 4, label = 'Obs PM2.5 (ug/m3) in June', color = 'darkorange')
...
for label in pic.get_xticklabels():
    label.set_rotation(45)   
plt.legend(bbox_to_anchor=(0.1, -0.09, 0.8, -0.09),  ncol= 4, mode="expand") 
    
    
pic = plt.subplot(6,2,6)
beijing_o3 = pic.plot(x_utc, cube_beijing_o3.data, linewidth=4, label = 'Model O3', color = 'limegreen')
beijing_o3_nudging = pic.plot(x_utc, cube_beijing_o3_nudge.data, linewidth=4, label = 'Nudged Model O3', color = 'darkblue')
obs_o3 = pic.plot(x_cn, y_o3_beijing, linewidth = 4, label = 'Obs O3 (ug/m3) in June', color = 'gold')
...
beijing_pm = pic.plot(x_utc, cube_beijing_pm.data, linewidth=4, label = 'Model NO2', color = 'k')
beijing_pm_nudging = pic.plot(x_utc, cube_beijing_pm_nudge.data, linewidth=4, label = 'Nudged Model NO2', color = 'sienna')
obs_pm = pic.plot(x_cn, y_pm_beijing, linewidth = 4, label = 'Obs NO2 (ug/m3) in June', color = 'red')
