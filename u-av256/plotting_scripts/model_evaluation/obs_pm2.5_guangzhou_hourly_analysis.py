...
data = xlrd.open_workbook('C:/Users/s1731217/measurement data/CN Y2014/Guangzhou/Guangzhou.xlsx')
#table = data.sheets()[1] #search sheet for index
table1 = data.sheet_by_name('广雅中学')
table2 = data.sheet_by_name('市五中')
table3 = data.sheet_by_name('广东商学院')
table4 = data.sheet_by_name('市八十六中')
table5 = data.sheet_by_name('番禺中学')
table6 = data.sheet_by_name('花都师范')
table7 = data.sheet_by_name('市监测站')
table8 = data.sheet_by_name('九龙镇镇龙')
table9 = data.sheet_by_name('麓湖')
table10 = data.sheet_by_name('帽峰山森林公园')
...
col_time_old_10 = table10.col_values(0)[1:]   
col_time_new_10 = table10.col_values(18)[1:]   
col_values_old_10 = table10.col_values(4)[1:]
# =============================================================================
# Loading data
# =============================================================================
...
df10 = pd.DataFrame(hourly_mean(col_time_old_10, col_values_old_10, col_time_new_10))

writer = pd.ExcelWriter('C:/Users/s1731217/measurement data/CN Y2014/Guangzhou/pm2.5_obs_guangzhou_hourly.xlsx')
df1.to_excel(writer, 'AVERAGE', index = False, header = ['广雅中学'], startcol = 0, merge_cells=False)
df2.to_excel(writer, 'AVERAGE', index = False, header = ['市五中'], startcol = 1, merge_cells=False)
df3.to_excel(writer, 'AVERAGE', index = False, header = ['广东商学院'], startcol = 2, merge_cells=False)
df4.to_excel(writer, 'AVERAGE', index = False, header = ['市八十六中'], startcol = 3, merge_cells=False)
df5.to_excel(writer, 'AVERAGE', index = False, header = ['番禺中学'], startcol = 4, merge_cells=False)
df6.to_excel(writer, 'AVERAGE', index = False, header = ['花都师范'], startcol = 5, merge_cells=False)
df7.to_excel(writer, 'AVERAGE', index = False, header = ['市监测站'],   startcol = 6, merge_cells=False)
df8.to_excel(writer, 'AVERAGE', index = False, header = ['九龙镇镇龙'], startcol = 7, merge_cells=False)
df9.to_excel(writer, 'AVERAGE', index = False, header = ['麓湖'], startcol = 8, merge_cells=False)
df10.to_excel(writer, 'AVERAGE', index = False, header = ['帽峰山森林公园'], startcol = 9, merge_cells=False)
