...
col_values_old_7 = table7.col_values(12)[1:]
...
writer = pd.ExcelWriter('C:/Users/s1731217/measurement data/CN Y2014/Guangzhou/o3_obs_guangzhou_hourly.xlsx')
df1.to_excel(writer, 'hourly', index = False, header = ['广雅中学'], startcol = 0, merge_cells=False)
df2.to_excel(writer, 'hourly', index = False, header = ['市五中'],   startcol = 1, merge_cells=False)
df3.to_excel(writer, 'hourly', index = False, header = ['广东商学院'], startcol = 2, merge_cells=False)
df4.to_excel(writer, 'hourly', index = False, header = ['市八十六中'], startcol = 3, merge_cells=False)
df5.to_excel(writer, 'hourly', index = False, header = ['番禺中学'], startcol = 4, merge_cells=False)
df6.to_excel(writer, 'hourly', index = False, header = ['花都师范'], startcol = 5, merge_cells=False)
df7.to_excel(writer, 'hourly', index = False, header = ['市监测站'], startcol = 6, merge_cells=False)
