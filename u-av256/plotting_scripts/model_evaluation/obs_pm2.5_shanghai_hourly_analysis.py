...
data = xlrd.open_workbook('C:/Users/s1731217/measurement data/CN Y2014/Shanghai/Shanghai.xlsx')
#table = data.sheets()[1] #search sheet for index
table1 = data.sheet_by_name('十五厂')
table2 = data.sheet_by_name('徐汇上师大')
table3 = data.sheet_by_name('青浦淀山湖')
table4 = data.sheet_by_name('静安监测站')
table5 = data.sheet_by_name('浦东川沙')
table6 = data.sheet_by_name('浦东新区监测站')
table7 = data.sheet_by_name('浦东张江')
...
writer = pd.ExcelWriter('C:/Users/s1731217/measurement data/CN Y2014/Shanghai/pm2.5_obs_shanghai_hourly.xlsx')
df1.to_excel(writer, 'AVERAGE', index = False, header = ['十五厂'], startcol = 0, merge_cells=False)
df2.to_excel(writer, 'AVERAGE', index = False, header = ['徐汇上师大'],   startcol = 1, merge_cells=False)
df3.to_excel(writer, 'AVERAGE', index = False, header = ['青浦淀山湖'], startcol = 2, merge_cells=False)
df4.to_excel(writer, 'AVERAGE', index = False, header = ['静安监测站'], startcol = 3, merge_cells=False)
df5.to_excel(writer, 'AVERAGE', index = False, header = ['浦东川沙'], startcol = 4, merge_cells=False)
df6.to_excel(writer, 'AVERAGE', index = False, header = ['浦东新区监测站'], startcol = 5, merge_cells=False)
df7.to_excel(writer, 'AVERAGE', index = False, header = ['浦东张江'], startcol = 6, merge_cells=False)
