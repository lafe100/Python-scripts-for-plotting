...
data = xlrd.open_workbook('C:/Users/s1731217/measurement data/CN Y2014/Hongkong/Hongkong.xlsx')
#table = data.sheets()[1] #search sheet for index
table1 = data.sheet_by_name('吉大')
table2 = data.sheet_by_name('前山')
table3 = data.sheet_by_name('唐家')
table4 = data.sheet_by_name('斗门')
table5 = data.sheet_by_name('长江旅游区')
...
writer = pd.ExcelWriter('C:/Users/s1731217/measurement data/CN Y2014/Hongkong/pm2.5_obs_hongkong_hourly.xlsx')
df1.to_excel(writer, 'AVERAGE', index = False, header = ['吉大'], startcol = 0, merge_cells=False)
df2.to_excel(writer, 'AVERAGE', index = False, header = ['前山'], startcol = 1, merge_cells=False)
df3.to_excel(writer, 'AVERAGE', index = False, header = ['唐家'], startcol = 2, merge_cells=False)
df4.to_excel(writer, 'AVERAGE', index = False, header = ['斗门'], startcol = 3, merge_cells=False)
df5.to_excel(writer, 'AVERAGE', index = False, header = ['长江旅游区'], startcol = 4, merge_cells=False)
