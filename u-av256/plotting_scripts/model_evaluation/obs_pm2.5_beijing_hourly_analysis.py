...
data = xlrd.open_workbook('C:/Users/s1731217/measurement data/CN Y2014/Beijing/Beijing.xlsx')
#table = data.sheets()[1] #search sheet for index
table1 = data.sheet_by_name('万寿西宫')
table2 = data.sheet_by_name('东四')
table3 = data.sheet_by_name('农展馆')
table4 = data.sheet_by_name('天坛')
table5 = data.sheet_by_name('奥体中心')
table6 = data.sheet_by_name('官园')
table7 = data.sheet_by_name('万柳')
...
writer = pd.ExcelWriter('C:/Users/s1731217/measurement data/CN Y2014/Beijing/pm2.5_obs_beijing_hourly.xlsx')
df1.to_excel(writer, 'hourly', index = False, header = ['万寿西宫'], startcol = 0, merge_cells=False)
df2.to_excel(writer, 'hourly', index = False, header = ['东四'],   startcol = 1, merge_cells=False)
df3.to_excel(writer, 'hourly', index = False, header = ['农展馆'], startcol = 2, merge_cells=False)
df4.to_excel(writer, 'hourly', index = False, header = ['天坛'], startcol = 3, merge_cells=False)
df5.to_excel(writer, 'hourly', index = False, header = ['奥体中心'], startcol = 4, merge_cells=False)
df6.to_excel(writer, 'hourly', index = False, header = ['官园'], startcol = 5, merge_cells=False)
df7.to_excel(writer, 'hourly', index = False, header = ['万柳'], startcol = 6, merge_cells=False)
