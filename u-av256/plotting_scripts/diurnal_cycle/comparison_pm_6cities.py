...
# =============================================================================
# Comparisons of aerosol concentrations in NCP, YRD & PRD; model: pm2.5; obs: pm2.5, pm10
# =============================================================================
...
filename  = '/exports/csce/datastore/geos/users/s1731217/output_ukca/u-av257/dumped_pp_files/June/pm2.5.pp'    # PM2.5 non-nudged
filename2 = '/exports/csce/datastore/geos/users/s1731217/output_ukca/u-av256/dumped_pp_files/June/pm2.5.pp'    # PM2.5 nudged
...
cube_beijing_pm10      = iris.analysis.interpolate.extract_nearest_neighbour(cube_unit_beijing, [('latitude', 39.90), ('longitude', 116.41)])
cube_shijiazhuang_pm10 = iris.analysis.interpolate.extract_nearest_neighbour(cube_unit_shijiazhuang, [('latitude', 38.04), ('longitude', 114.51)])
cube_shanghai_pm10     = iris.analysis.interpolate.extract_nearest_neighbour(cube_unit_shanghai, [('latitude', 31.23), ('longitude', 121.47)])
cube_nanjing_pm10      = iris.analysis.interpolate.extract_nearest_neighbour(cube_unit_nanjing , [('latitude', 32.06), ('longitude', 118.80)])
cube_guangzhou_pm10    = iris.analysis.interpolate.extract_nearest_neighbour(cube_unit_guangzhou, [('latitude', 23.13), ('longitude', 113.26)])
cube_hongkong_pm10     = iris.analysis.interpolate.extract_nearest_neighbour(cube_unit_hk  , [('latitude', 22.33), ('longitude', 114.19)])
...
cube_unit_beijing2      = cube2[0]*1.185*1.0e9
cube_unit_shijiazhuang2 = cube2[0]*1.181*1.0e9
cube_unit_shanghai2     = cube2[0]*1.185*1.0e9
cube_unit_nanjing2      = cube2[0]*1.185*1.0e9
cube_unit_guangzhou2    = cube2[0]*1.169*1.0e9
cube_unit_hk2           = cube2[0]*1.169*1.0e9

cube_beijing_pm1        = iris.analysis.interpolate.extract_nearest_neighbour(cube_unit_beijing2, [('latitude', 39.90), ('longitude', 116.41)])
cube_shijiazhuang_pm1   = iris.analysis.interpolate.extract_nearest_neighbour(cube_unit_shijiazhuang2, [('latitude', 38.04), ('longitude', 114.51)])
cube_shanghai_pm1       = iris.analysis.interpolate.extract_nearest_neighbour(cube_unit_shanghai2 , [('latitude', 31.23), ('longitude', 121.47)])
cube_nanjing_pm1        = iris.analysis.interpolate.extract_nearest_neighbour(cube_unit_nanjing2   , [('latitude', 32.06), ('longitude', 118.80)])
cube_guangzhou_pm1      = iris.analysis.interpolate.extract_nearest_neighbour(cube_unit_guangzhou2 , [('latitude', 23.13), ('longitude', 113.26)])
cube_hongkong_pm1       = iris.analysis.interpolate.extract_nearest_neighbour(cube_unit_hk2  , [('latitude', 22.33), ('longitude', 114.19)])
# =============================================================================
# Mean of hour
# =============================================================================
...
# cube_city_list_pm10 is actually the PM2.5 of non-nudged model;
# cube_city_list_pm1  is actually the PM2.5 of nudged model
...
x = np.arange(1,25)
nanjing = pic.plot(x, PM10_Nanjing, linewidth=4, label = 'Modelled PM1 (non-nudged)', color = 'darkblue')
nanjing2 = pic.plot(x, PM1_Nanjing, linewidth=4, label = 'Modelled PM1 (nudged)', color = 'green')
...
plt.title('Comparisons of PM in Nanjing (June 2014)')
plt.xlabel('hour per day')
plt.ylabel(' PM  (ug/m3)')
...
plt.savefig('/exports/csce/datastore/geos/users/s1731217/output_ukca/u-av256/plotting_scripts/diurnal_cycle/Comparison_PM_6cities.png', dpi=600, transparent=True)
#plt.savefig('Z:/output_ukca/u-av256/plotting_scripts/diurnal_cycle/Comparison_PM_6cities.png', dpi=600, transparent=True)
plt.show()
