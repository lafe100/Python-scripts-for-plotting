...
cb1.ax.set_yticklabels([0.01, 2, 0.6, 1, 2, 3, 4, 5, 6], fontsize=8)
cb1.set_label('ppb')

plt.subplot(3,4,2)
plt.title('C5H8 Feb 2014',  fontsize=5)
tick_levels = [0.01, 0.1, 0.2, 0.4, 0.6, 0.8, 1, 1.5, 2, 2.5, 3, 3.5, 4]
...
plt.subplot(3,4,3)
plt.title('C5H8 Mar 2014',  fontsize=5)
tick_levels = [0.01, 0.1, 0.2, 0.4, 0.6, 0.8, 1, 1.5, 2, 2.5, 3, 3.5, 4]
...
plt.subplot(3,4,4)
plt.title('C5H8 Apr 2014',  fontsize=5)
tick_levels = [0.01, 0.1, 0.2, 0.4, 0.6, 0.8, 1, 1.5, 2, 2.5, 3, 3.5, 4]
...
plt.subplot(3,4,5)
plt.title('C5H8 May 2014',  fontsize=5)
tick_levels = [0.01, 0.1, 0.2, 0.4, 0.6, 0.8, 1, 1.5, 2, 2.5, 3, 3.5, 4]
...
plt.subplot(3,4,6)
plt.title('C5H8 Jun 2014',  fontsize=5)
tick_levels = [0.01, 0.1, 0.2, 0.4, 0.6, 0.8, 1, 1.5, 2, 2.5, 3, 3.5, 4]
...
plt.subplot(3,4,7)
plt.title('C5H8 Jul 2014',  fontsize=5)
tick_levels = [0.01, 0.1, 0.2, 0.4, 0.6, 0.8, 1, 1.5, 2, 2.5, 3, 3.5, 4]
...
plt.subplot(3,4,8)
plt.title('C5H8 Aug 2014',  fontsize=5)
tick_levels = [0.01, 0.1, 0.2, 0.4, 0.6, 0.8, 1, 1.5, 2, 2.5, 3, 3.5, 4]
...
plt.subplot(3,4,9)
plt.title('C5H8 Sep 2014',  fontsize=5)
tick_levels = [0.01, 0.1, 0.2, 0.4, 0.6, 0.8, 1, 1.5, 2, 2.5, 3, 3.5, 4]
...
plt.subplot(3,4,10)
plt.title('C5H8 Oct 2014',  fontsize=5)
tick_levels = [0.01, 0.1, 0.2, 0.4, 0.6, 0.8, 1, 1.5, 2, 2.5, 3, 3.5, 4]
...
plt.subplot(3,4,11)
plt.title('C5H8 Nov 2014',  fontsize=5)
tick_levels = [0.01, 0.1, 0.2, 0.4, 0.6, 0.8, 1, 1.5, 2, 2.5, 3, 3.5, 4]
...
plt.subplot(3,4,12)
plt.title('C5H8 Dec 2014',  fontsize=5)
tick_levels = [0.01, 0.1, 0.2, 0.4, 0.6, 0.8, 1, 1.5, 2, 2.5, 3, 3.5, 4]
...
plt.savefig('/exports/csce/datastore/geos/users/s1731217/output_ukca/u-av256/plotting_scripts/map/c5h8_monthly_2014.png', dpi=600, transparent=True)
